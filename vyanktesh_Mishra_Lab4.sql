...
/*3)	Display the total number of customers based on gender who
 have placed orders of worth at least Rs.3000.*/
 
 select c.CUS_GENDER as GENDER ,count(distinct c.CUS_NAME) as NoOfCustomers
 from customer as c
 inner join `order` as o on c.CUS_ID = o.CUS_ID where o.ORD_AMOUNT>=3000 group by c.CUS_GENDER  ;
